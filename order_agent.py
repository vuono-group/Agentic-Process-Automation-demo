...
# Create an order identification agent with batch processing tool
order_agent = Agent(
    ...
    """,
    # Using only the batch processing tool since it's what's used in the orchestration workflow
